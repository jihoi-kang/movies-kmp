...
/**
 * DroidKnights 참고
 * https://github.com/droidknights/DroidKnightsApp/blob/2025%2Fcompose-multiplatform/core/designsystem/src/commonMain/kotlin/com/droidknights/app/core/designsystem/theme/Typography.kt
 *
 * 크게 5가지(Display, Headline, Title, Label, Body)로 분류
 */
@Immutable
data class VallabTypography(
...
internal val LocalTypography = staticCompositionLocalOf<VallabTypography> {
    error("VallabTypography를 provide 해야합니다.")
}
